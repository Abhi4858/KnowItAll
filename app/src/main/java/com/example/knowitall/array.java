...
public class array extends AppCompatActivity implements View.OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            c1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), array_basics.class);
            ...
            c2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), linearsearch.class);
                    startActivity(intent);
                }
            } );
    ...
    public void onClick(View view) {
        Intent i;
        switch (view.getId()){
            case R.id.item1: i = new Intent(this , array_basics.class); startActivity(i); break;
            case R.id.item2: i = new Intent(this , linearsearch.class); startActivity(i); break;
            case R.id.item3: i = new Intent(this , binarysearch.class); startActivity(i); break;

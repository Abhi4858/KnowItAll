...
public class linkedlist extends AppCompatActivity implements View.OnClickListener{
    CardView c1;
    CardView c2;
    CardView c3;
    CardView c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), singly.class);
        ...
        c2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), doubly.class);
                startActivity(intent);
            }
        } );
        ...
        c3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), circular.class);
                startActivity(intent);
            }
        } );

        c4 = findViewById(R.id.item4);
        c5 = findViewById(R.id.item5);
        c6 = findViewById(R.id.item6);
    ...
    public void onClick(View view) {
        Intent i;
        switch (view.getId()){
            case R.id.item1: i = new Intent(this , singly.class); startActivity(i); break;
            case R.id.item2: i = new Intent(this , doubly.class); startActivity(i); break;
            case R.id.item3: i = new Intent(this , circular.class); startActivity(i); break;
